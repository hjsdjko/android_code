...
import com.design.appproject.logic.viewmodel.wupinleixing.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.WupinleixingcommonDetailsLayoutBinding
 ...
 * 物品类型详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_WUPINLEIXING)
class DetailsFragment : BaseBindingFragment<WupinleixingcommonDetailsLayoutBinding>() {
    ...
    private var mWupinleixingItemBean=WupinleixingItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mWupinleixingItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("wupinleixing",mId.toString())
    }


    private fun WupinleixingcommonDetailsLayoutBinding.setInfo(){
        wupinleixingTv.text = "${mWupinleixingItemBean.wupinleixing}"
    }
