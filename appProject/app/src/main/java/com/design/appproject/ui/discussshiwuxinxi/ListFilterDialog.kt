...
import com.design.appproject.databinding.DiscussshiwuxinxiFilterDialogLayoutBinding
...
class ListFilterDialog(context: Context) : DrawerPopupView(context) {
    ...
    lateinit var binding: DiscussshiwuxinxiFilterDialogLayoutBinding
    ...
    override fun onCreate() {
        ...
        binding.apply {
            ...
            ensureBtn.setOnClickListener { //确定
                params.clear()
                contentEt.text.toString().isNotNullOrEmpty().yes {
                    val filterContent = contentEt.text.toString()
                    params.put("content","%${filterContent}%")
                }
